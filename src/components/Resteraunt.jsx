    ...
    <div>
      ...
      <div id="business-page">
        <div id="business-image">
          <img id="business-img " src="https://www.vandalnewyork.com/wp-content/uploads/2016/02/Screenshot-2017-06-14-11.24.47.jpg" alt="resteruant" />
        </div>


        <div id="resteraunt-about">
          <img id="resteraunt-img" src="https://www.vandalnewyork.com/wp-content/uploads/2016/02/Screenshot-2017-06-14-11.24.47.jpg" alt="resteruant" />
        ...
        <div id="gallery-area">
          <p id="gallery-head" className=" about">Artists</p>
